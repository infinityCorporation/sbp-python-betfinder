# For game props, there are two focuses:
# Firstly, the goal is to create a method where we can add all game props (q1, q2, etc.) to the same event row
# and then simply compare based on name (look at documentation for this first)
# Secondly, the correct point/names must be compared, otherwise this does not work.
...
# Replace this with the new markets for game props, leave existing sports that must remain
...
## The following info may be the same for game props
